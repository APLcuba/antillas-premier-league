...
export default function MatchesEdit({ match, teams, seasons, stadiums }) {
    ...
    return (
        <AdminLayout title={`Editar Partido #${match.id}`}>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-white">
                    Editar Partido: {match.home_team?.name} vs {match.away_team?.name}
                </h1>
                <Link
                    href="/admin/matches"
